...
\begin{dedicatoria}
   ...
   \centering
   \noindent
   \textit{Figado nem é bife.} \vspace*{\fill}
\end{dedicatoria}
...
Gostaria de expressar meus agradecimentos a todas as pessoas que contribuíram, de forma direta ou indireta, para a realização deste trabalho. Especialmente, gostaria de formalizar esses agradecimentos a algumas pessoas:

Agradeço, primeiramente, a Deus, que esteve comigo em todos os momentos me dando forças, Graças a ele tudo isso foi possível.

À minha maravilhosa noiva e futura esposa, Luana, por sempre me apoiar e ser minha principal incentivadora.

Aos meus queridos pais, que sempre me deram suporte e permitiram que tudo isso fosse possível.

À minha excelente orientadora, Patrícia, que aceitou de imediato meu pedido de orientação, mesmo enfrentando dificuldades de saúde, sempre deu o seu melhor para comigo e este trabalho.

A todos os ótimos professores que tive ao longo do curso, pelos conhecimentos compartilhados, que contribuíram para minha formação como profissional.

Aos incríveis amigos que tive o privilégio de conhecer durante o curso, que tornaram essa jornada de graduação divertida.

A todos que jogaram o jogo e deram feedback.

E por fim, aos artistas que criaram alguns dos sprites utilizados no jogo e os disponibilizaram de forma gratuita na internet.
...
\begin{resumo}
Com o avanço da tecnologia e a consequente melhoria na qualidade de vida, a busca por entretenimento tornou-se cada vez mais frequente. O uso intensivo de celulares e computadores, somado às constantes notificações, tem distraído os estudantes, impactando negativamente seus resultados acadêmicos. Cada vez mais os educadores estão em busca de formas a manter seus alunos engajados e interessados em suas aulas.

Com a ideia de ajudar a iniciação de novos membros no LabES em sua chegada ao laboratório, foi desenvolvido um jogo RPG com propósitos educacionais. O objetivo é facilitar o aprendizado e a integração de novos estudantes ao laboratório, o jogo aborda questões que são pertinentes ao laboratório e ajuda o jogador a aprender de maneira interativa.

\textbf{Palavras-chaves}: jogos. educação. rpg. Pygame. Pixel Art. Tiled. 
\end{resumo}
...
\begin{siglas}
  ...
  \item[LabES] Laboratório de Práticas em Engenharia de Software “Ricardo de Almeida Falbo”
  \item[SEEDES] Startups and Entrepreneurship Ecosystem Development do Espírito Santo
  \item[SigAMAES] Sistema de Informação Gerencial para AMAES
  \item[AMAES]  Associação dos Amigos dos Autistas do ES
  \item[Q2L] Quest to Learn
  \item[PGB] Pesquisa Game Brasil
  \item[SDL] Simple DirectMedia Layer
  \item[2D] Two-dimensional
  \item[3D] Three-dimensional
  \item[XML] Extensible Markup Language
  \item[TMX] Translation Memory eXchange
...
\include{capitulos/ch4-implementacao}
\include{capitulos/ch5-avaliacao}
\include{capitulos/ch6-conclusoes}
\include{capitulos/ch7-dicaslatex}
