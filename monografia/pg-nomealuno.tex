...
Gostaria de expressar meus agradecimentos a todas as pessoas que contribuíram de forma direta ou indiretamente para a realização desse trabalho mas especialmente gostaria de formalizar isso a algumas pessoas:

Agradeço primeiramente a Deus que esteve comigo e me deu forças e permitiu que tudo isso fosse possível.

À minha noiva e futura esposa por sempre me apoiar e ser a minha principal incentivadora.

À minha família que sempre me deu suporte e permitiu que tudo isso fosse possível.

À minha orientadora Patrícia que aceitou o pedido de me orientar de imediato e me deu conselhos preciosos. 

À todos os professores que tive ao longo do curso, pelos conhecimentos compartilhados, que contribuíram para a minha formação como profissional.

Aos meus amigos de curso que tornaram essa jornada da graduação divertida.

A todos que jogaram o jogo e deram feedback.

Aos artistas que fizeram alguns dos sprites utilizados no jogo e disponibilizaram. 
...
\begin{resumo}
Com o avanço da tecnologia e a consequente melhoria na qualidade de vida, a busca por entretenimento tornou-se cada vez mais frequente. O uso intensivo de celulares e computadores, somado às constantes notificações, tem distraído os estudantes, impactando negativamente seus resultados acadêmicos. Cada vez mais os educadores estão em busca de formas a manter os seus alunos engajados e interessados em suas aulas.

Com a ideia de ajudar a iniciação de novos membros no LabES em sua chegada ao laboratório, foi desenvolvido um jogo RPG com propósitos educacionais. O objetivo é facilitar o aprendizado e a integração de novos estudantes ao laboratório, o jogo aborda questões que são pertinentes ao laboratório e ajuda o jogador a aprender

\textbf{Palavras-chaves}: jogos. educação. rpg. pygame. pixel art.
\end{resumo}
